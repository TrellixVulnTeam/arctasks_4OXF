...
from .django import (
    coverage, dbshell, makemigrations, migrate, runserver, run_mod_wsgi, shell, test)
...
from .static import build_css, build_static, bower, collectstatic, lessc, pull_media, sass
